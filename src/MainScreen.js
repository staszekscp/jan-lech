    ...
    <div className="backdrop">
      <div className={fadeOut2?"out":"main"}>
        <div className="main-screen">
            <div className={fadeOut?"out":"fade-long"}>
            ...
            {startGame && <div className="explanation-container" >
                <h1>Kraków, 1925</h1>
                ...
                <p>Oraz poznać nieco bliżej przedwojenny Kraków...</p>
                <div className="button-upper" onClick={()=>{
                            setTimeout(() => {
                                props.current(false)
                                props.forward(true)
            ...
            {info && <div className="explanation-container" >
                ...
                <p>Gra inspirowana jest prawdziwymi wydarzeniami, lecz większość postaci jest fikcyjna. Wyjątek stanowią: Marian Dąbrowski (zdjęcie prawdziwe), Hirsz Thorn, Leopold Macharski, Józef Mehoffer (zdjęcie prawdziwe) oraz Tadeusz Boy-Żeleński (zdjęcie prawdziwe). Ponownie jednak zaznaczam, iż wypowiadane przez postacie kwestie zostały przeze mnie wymyślone.</p>
                ...
                <p>https://commons.wikimedia.org/wiki/File:Krak%C3%B3w_ W%C5%82adys%C5%82awa_%C5%81okietka_32_Rogatka_miejska_Pod_Figur%C4%85.JPG</p>
                <div className="button-upper" onClick={()=>{
                            setTimeout(() => {
                                setInfo(false)
                            }, 2000)
